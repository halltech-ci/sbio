...
class HtaPos(models.Model):
    ...
    delivery_status = fields.Selection([('draft', 'A livrer'), ('cancel', 'Cancelled'), ('delivery', 'En livraison'), ('invoiced', 'Payé livré'), ('direct', 'Direct'), ('return', 'Retour')], 'Delivery Status', compute="_compute_delivery_status", readonly=True, copy=False, default='draft', index=True)
